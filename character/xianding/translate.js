...
const translates = {
	...
	caohua: "曹华",
	caiyi: "彩翼",
	caiyi_info: "转换技。结束阶段，你可令一名角色选择并执行一项，然后若不为第四项，则移除此选项。阳：⒈回复X+1点体力。⒉摸X+2张牌，⒊复原武将牌。⒋随机执行一个已经移除过的阳选项；阴：⒈受到X+1点伤害。⒉弃置X+2张牌。⒊翻面并横置。⒋随机执行一个已经移除过的阴选项。（X为该阴阳态剩余选项的数量）。",
	guili: "归离",
	...
	dcsbmoyou: "谟猷",
	dcsbmoyou_info: "你每使用两张手牌结算后，可以摸三张牌，并选择一种花色弃置手牌中所有此花色的牌，若你手牌未含有所有类型，本回合下次使用基本牌无次数与距离限制，使用锦囊牌不可响应。",
	dcsbshiao: "恃傲",
